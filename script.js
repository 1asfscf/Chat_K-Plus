// ==========================================
// 🧠 Chat K plus v2.4.1 - FULL (65개 KB + 시간표 패치)
// ==========================================
...
function startChat(query) {
    ...
    setTimeout(() => {
        if (localStorage.getItem('timetableJustSaved') === 'true') {
            addMessage(`✅ ${timetableData.school} 시간표 저장 완료!`, 'ai');
...
document.addEventListener('DOMContentLoaded',()=>{initTheme();initTimetableSystem();homeScreen.classList.add('slide-in');chatScreen.classList.add('hidden');});
