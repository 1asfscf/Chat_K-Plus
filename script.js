...
정교회는 2천년 역사를 간직한 가장 오래된 기독교 전통 중 하나야. 신비롭고도 깊은 영성을 경험할 수 있어.
...
**주요 특징**
- **이콘(성화상)**: 예배와 신학의 핵심. '보이는 복음'이라 불려
- **부활절**: 가장 중요한 축일
...
윤회는 삶과 죽음을 바라보는 아주 오래된 지혜야. 우리의 행동이 다음 생을 만든다는 믿음은 많은 사람들에게 깊은 통찰을 줘.

**개념**
- 죽은 후 영혼이 다시 태어나는 순환 과정
- 산스크리트어 '삼사라(Samsara)': 끊임없는 윤회의 수레바퀴
- 인도 발생 사상, 불교·힌두교·자이나교의 핵심 교리
...
예수는 인류 역사상 가장 큰 영향력을 가진 인물 중 한 분이야. 사랑과 용서의 메시지는 2천년이 지난 지금도 수많은 사람들의 마음을 울리고 있어.
...
사서삼경은 동아시아 2천년 사상의 뿌리야. 공자와 맹자의 지혜가 담긴 이 책들은 지금도 우리 삶에 깊은 통찰을 줘.

**사서(四書)** - 주희가 정리한 4대 핵심서

**1. 논어(論語)**
공자와 제자들의 대화록. 인(仁)·예(禮)의 핵심.
_"己所不欲 勿施於人" (네가 원치 않는 바를 남에게 베풀지 말라)_

**2. 맹자(孟子)**
맹자의 사상서. 성선설(인간의 본성은 선하다).
_"民爲貴 社稷次之 君爲輕" (백성이 가장 귀중하다)_

**3. 대학(大學)**
수신제가치국평천하(修身齊家治國平天下)의 원리.
_"대학의 도는 명덕을 밝히는 데 있다"_

**4. 중용(中庸)**
중(中)과 화(和)의 철학.
_"군자의 도는 평범한 데서 시작된다"_

**삼경(三經)** - 유교의 3대 기본 경전

**1. 시경(詩經)** - 중국 최고(最古)의 시집. 305편
**2. 서경(書經)** - 상고시대 정치 문서집. "天命靡常"
**3. 주역(周易)** - 64괘의 음양 원리. "易有太極"

📚 2천년이 지나도 빛나는 지혜야. 한 구절 한 구절이 인생의 나침반이 되어줄 거야.`,
    sources: [
...
const replies = {
  ...
  blocked: [
    `${userName}, 그 질문은 답변할 수 없어. Chat K Plus는 모든 사용자에게 안전한 경험을 제공하려고 노력하고 있어. 부적절한 내용 대신 궁금한 지식이나 정보를 물어봐 주면 최선을 다해 답변할게. 🙏`,
    `부적절한 내용이 감지됐어 ${userName}. Chat K Plus는 건전한 대화를 지향해. 과학, 기술, 건강, 역사, 종교 등 다양한 분야의 질문은 언제든 환영이야! 😊`,
