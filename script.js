...
const replies = {
  ...
  blocked: [
    `Chat K Plus는 그 질문에 답변하기 어려워, ${userName}. 😊 대신 이런 주제는 어때?\n\n✨ **자신 있게 답할 수 있는 분야**\n🔬 과학·물리·화학·우주\n💻 프로그래밍·코딩·웹개발\n📚 공부법·영어·학습전략\n💪 건강·운동·수면·영양\n🎬 한국영화·감독·배우\n🙏 종교·철학·역사\n🥤 음료·커피·차\n🚗 또봇·도라에몽·포켓몬\n\n다른 궁금한 건 없을까? 내가 도와줄게! 🌟`,
    `${userName}, 그 주제는 Chat K Plus 정책상 다루기 어려워. 하지만 실망하지 마! 🙌\n\n내가 특히 잘 아는 것들:\n📖 역사 팩트체크 (5.18 광주민주화운동 등)\n💙 감정 상담과 위로\n🧦 일상 꿀팁 (양말 관리 등)\n📱 아이폰 트러블슈팅\n\n이 중에 관심 있는 주제 있어? 편하게 물어봐! 😊`,
    `${userName}, 미안하지만 그 질문은 답변이 어려워. 대신 내가 진짜 도움 될 만한 정보를 줄게! 🌈\n\n지금 바로 물어볼 수 있는 인기 질문:\n"과학이 뭐야?"\n"공부 잘하는 법 알려줘"\n"또봇 정보 알려줘"\n"아이폰 터치 안 될 때 해결법"\n"음료별 칼로리 비교"\n\n무엇부터 알아볼까? 😄`
  ],
  stopped: [
